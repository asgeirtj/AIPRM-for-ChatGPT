...
function openSuccessPage() {
  chrome.tabs.create({
    url: `https://www.aiprm.com/success/install-claude?utm_campaign=success-install&utm_content=${VERSION}&utm_source=claude&utm_medium=extension`,
    active: false,
  });
}

chrome.runtime.onInstalled.addListener(function (details) {
  // if it is an install event open Claude
...
chrome.omnibox.onInputEntered.addListener((text) => {
  chrome.tabs.create({
    url: `https://claude.ai/new?AIPRM_Prompt=${encodeURIComponent(text)}`,
  });
});
