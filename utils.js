const svg = function (name) {
  ...
  switch (name) {
    ...
    case 'EyeSlashSmall':
      return '<svg aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" class="AIPRM__h-4 AIPRM__w-4" xmlns="http://www.w3.org/2000/svg"><path d="M3.98 8.223A10.477 10.477 0 001.934 12C3.226 16.338 7.244 19.5 12 19.5c.993 0 1.953-.138 2.863-.395M6.228 6.228A10.45 10.45 0 0112 4.5c4.756 0 8.773 3.162 10.065 7.498a10.523 10.523 0 01-4.293 5.774M6.228 6.228L3 3m3.228 3.228l3.65 3.65m7.894 7.894L21 21m-3.228-3.228l-3.65-3.65m0 0a3 3 0 10-4.243-4.243m4.242 4.242L9.88 9.88" stroke-linecap="round" stroke-linejoin="round"></path></svg>';
    case 'Referral':
...
const css = function (name) {
  ...
  switch (name) {
    case 'SidebarButton':
      return 'AIPRM__flex AIPRM__p-2 AIPRM__items-center AIPRM__gap-3 AIPRM__rounded-md hover:AIPRM__bg-bg-400 dark:hover:AIPRM__bg-dark-bg-300 AIPRM__transition-colors AIPRM__duration-200 AIPRM__cursor-pointer AIPRM__text-sm dark:AIPRM__text-gray-100 AIPRM__text-gray-900 AIPRM__sidebar-button AIPRM__whitespace-nowrap AIPRM__overflow-hidden';
    case 'column':
    ...
    case 'card':
      return 'AIPRM__flex AIPRM__flex-col AIPRM__gap-2 AIPRM__w-full AIPRM__bg-bg-200 dark:AIPRM__bg-dark-bg-200 AIPRM__p-4 AIPRM__rounded-md hover:AIPRM__bg-bg-400 dark:hover:AIPRM__bg-dark-bg-300 AIPRM__text-left';
    case 'p':
    ...
    case 'paginationButton':
      return 'AIPRM__px-4 AIPRM__py-2 AIPRM__font-medium AIPRM__bg-bg-300 hover:AIPRM__bg-bg-400 dark:AIPRM__bg-dark-bg-200 dark:AIPRM__border-gray-700 dark:AIPRM__text-gray-400 dark:hover:AIPRM__text-white dark:hover:AIPRM__bg-dark-bg-300';
    case 'continueButton':
      return 'AIPRM__py-2 AIPRM__font-medium AIPRM__bg-bg-300 hover:AIPRM__bg-bg-400 dark:AIPRM__bg-dark-bg-200 dark:AIPRM__border-gray-700 dark:hover:AIPRM__bg-dark-bg-400 disabled:AIPRM__text-gray-300 disabled:hover:AIPRM__bg-transparent AIPRM__rounded-l-md AIPRM__px-4';
    case 'continueActionSelect':
      return 'AIPRM__select AIPRM__bg-bg-300 AIPRM__border-0 AIPRM__border-l AIPRM__text-sm AIPRM__rounded-r-md AIPRM__block AIPRM__w-2 dark:AIPRM__bg-dark-bg-200 AIPRM__border-bg-400 dark:AIPRM__border-gray-700 dark:hover:AIPRM__bg-dark-bg-300 dark:AIPRM__placeholder-gray-400 dark:AIPRM__text-white hover:AIPRM__bg-bg-400 focus:AIPRM__ring-0 focus:AIPRM__border-gray-200 AIPRM__pr-6';
    case 'action':
      return 'AIPRM__p-1 AIPRM__rounded-md hover:AIPRM__bg-bg-300 hover:AIPRM__text-gray-700 dark:AIPRM__text-gray-400 dark:hover:AIPRM__bg-dark-bg-300 dark:hover:AIPRM__text-gray-200 disabled:dark:hover:AIPRM__text-gray-400 md:AIPRM__invisible md:group-hover:AIPRM__visible';
    case 'tag':
      return 'AIPRM__inline-flex AIPRM__items-center AIPRM__py-1 AIPRM__px-2 AIPRM__mr-2 AIPRM__mb-2 AIPRM__text-sm AIPRM__font-medium AIPRM__text-white AIPRM__rounded AIPRM__bg-dark-bg-300 AIPRM__whitespace-nowrap';
    case 'languageSelectWrapper':
      return 'AIPRM__flex AIPRM__gap-3 lg:AIPRM__max-w-3xl md:last:AIPRM__mb-6 AIPRM__ml-2 md:AIPRM__ml-0 AIPRM__pt-2 AIPRM__stretch AIPRM__justify-between AIPRM__text-sm AIPRM__items-end AIPRM__pb-2 AIPRM__mb-2 AIPRM__border-b AIPRM__border-black/10 AIPRM__flex-col sm:AIPRM__flex-row dark:AIPRM__border-gray-700';
    case 'select':
      return 'AIPRM__select AIPRM__bg-bg-300 AIPRM__border-0 AIPRM__text-sm AIPRM__rounded AIPRM__block AIPRM__w-full dark:AIPRM__bg-dark-bg-200 dark:AIPRM__border-gray-600 dark:hover:AIPRM__bg-dark-bg-300 dark:AIPRM__placeholder-gray-400 dark:AIPRM__text-white hover:AIPRM__bg-bg-400 focus:AIPRM__ring-0 AIPRM__px-3 AIPRM__py-2';
    case 'selectLabel':
