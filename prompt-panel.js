...
export class PromptPanel {
  ...
  constructor(
    ...
    this.promptPanel.classList =
      'AIPRM__absolute AIPRM__bottom-8 AIPRM__left-0 AIPRM__z-20 AIPRM__w-full AIPRM__space-y-2 AIPRM__hidden';

    this.promptPanel.innerHTML = /*html*/ `
          <div class="AIPRM__rounded-2xl AIPRM__border AIPRM__border-black/[0.1] dark:AIPRM__border-white/[0.1] AIPRM__p-2 AIPRM__shadow-lg AIPRM__bg-bg-0 dark:AIPRM__bg-dark-bg-0">
            <input id="AIPRM__PromptPanel__search-input" autocomplete="off" placeholder="Search AIPRM prompts" class="AIPRM__mb-1 AIPRM__w-full AIPRM__border-0 AIPRM__white AIPRM__p-2 AIPRM__text-sm focus:AIPRM__outline-none focus:!AIPRM__shadow-none AIPRM__bg-bg-0 dark:AIPRM__bg-dark-bg-0">
    ...
    // prevent stealing of focus from search input by prompt composer
  ...
  handleInput() {
    const query = this.inputField.innerText;
  ...
  renderPrompts() {
    ...
    this.prompts.forEach((prompt) => {
      ...
      promptElement.className =
        'AIPRM__group AIPRM__flex AIPRM__h-10 AIPRM__items-center AIPRM__gap-2 AIPRM__rounded-lg AIPRM__px-2 AIPRM__font-medium hover:AIPRM__bg-bg-200 AIPRM__text-sm AIPRM__text-gray-950 dark:AIPRM__text-gray-100 dark:hover:AIPRM__bg-dark-bg-200';
