              ...
              <div class="AIPRM__bg-white dark:AIPRM__bg-gray-900 AIPRM__px-4 AIPRM__pt-5 AIPRM__pb-4 sm:AIPRM__p-6 sm:AIPRM__pb-4">
                ...
                <div id="reportPromptIntroText">
                  ...
                  <div class="AIPRM__mt-2">
                    ...
                    <select data-prompt-id="${prompt.ID}" id="FeedbackTypeNo" name="FeedbackTypeNo" class="AIPRM__select AIPRM__mt-2 AIPRM__mb-3 AIPRM__bg-gray-100 dark:AIPRM__bg-gray-850 dark:AIPRM__border-gray-850 dark:hover:AIPRM__bg-gray-800 AIPRM__rounded AIPRM__w-full AIPRM__px-3 AIPRM__py-2" required>
...
const getFeedbackFormTemplate = (selectedFeedbackTypeNo, promptID) => {
  ...
  return /*html*/ `
    <p class="AIPRM__mb-6">
      Since we are not affiliated with Anthropic or Claude,
      we are not responsible for the output of Claude.<br><br>
