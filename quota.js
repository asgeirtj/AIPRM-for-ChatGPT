...
let QuotaMessages = {
  ...
  <h3>Connect Claude and AIPRM Accounts</h3>

  <p class="AIPRM__my-4">
    We are excited to announce that you can now connect your Claude account with your AIPRM account.
    <br><br>
  ...
  <p class="AIPRM__my-4">
    To use the "Favorites" prompts list, you must connect your Claude account with your AIPRM account.
  ...
  <p class="AIPRM__my-4">
    ...
    you must connect your Claude account with your AIPRM account and subscribe to the <b>AIPRM Plus</b> plan or higher.
  </p>`,
  ...
  <p class="AIPRM__my-4">
    To create a custom prompt list, you must connect your Claude account with your AIPRM account and subscribe to the <b>AIPRM Plus</b> plan or higher.
  ...
  <p class="AIPRM__my-4">
    To use private prompts, you must connect your Claude account with your AIPRM account.
  ...
  <p class="AIPRM__my-4">
    To use team prompts, you must connect your Claude account with your AIPRM account.
  ...
  <p class="AIPRM__my-4">
    ...
    <br><br>
    Connect your Claude account with your AIPRM account to be able to create more prompts.
    <br><br>
  ...
  <p class="AIPRM__my-4">
    To use the "AIPRM Verified Prompts" list, you must connect your Claude account with your AIPRM account and subscribe to the <b>AIPRM Pro</b> plan.
  </p>`,
  ...
  <p class="AIPRM__my-4">
    To view prompt template source, you must connect your Claude account with your AIPRM account and subscribe to the <b>AIPRM Elite</b> plan or higher.
  </p>`,
  ...
  <p class="AIPRM__my-4">
    To use the Live Crawling feature, you must connect your Claude account with your AIPRM account and subscribe to the <b>AIPRM Elite</b> plan or higher.
  </p>`,
  ...
  <p class="AIPRM__my-4">
    To use the Hide Watermark feature, you must connect your Claude account with your AIPRM account and subscribe to the <b>AIPRM Elite</b> plan or higher.
  </p>`,
  ...
  <p class="AIPRM__my-4">
    ...
    <br><br>
    Connect your Claude account with your AIPRM account to be able to use Custom Index feature.
    <br><br>
  ...
  <p class="AIPRM__my-4">
    Connect your Claude account with your AIPRM account to be able to use Invite a Friend & Earn feature.
  </p>`,
  ...
  <p class="AIPRM__my-4">
    ...
    <br><br>
    Connect your Claude account with your AIPRM account to extend your prompt limit.
    <br><br>
  ...
  <p class="AIPRM__my-4">
    ...
    <br><br>
    Connect your Claude account with your AIPRM account to increase your daily prompt allowance.
    <br><br>
  ...
  <p class="AIPRM__my-4">
    ...
    <br><br>
    Connect your Claude account with your AIPRM account immediately to increase your prompt limit.
    <br><br>
  ...
  <p class="AIPRM__my-4">
    ...
    <br><br>
    To continue using the service, connect your Claude account with your AIPRM account to increase your prompt limit.
    <br><br>
  ...
  <p class="AIPRM__my-4">
    ...
    <br><br>
    Connect your Claude account with your AIPRM account to be able to send more prompts.
    <br><br>
...
export class UserQuota {
   ...
   * (requires Claude account to be connected with AIPRM account & max. private list items quota not exceeded)
   *
   * @param {import('./list.js').Lists} lists
   * @returns {boolean}
   */
  canUseFavorites(lists) {
    // Claude account must be connected to AIPRM account
   ...
   * (requires Claude account to be connected with AIPRM account, min. 3 private lists quota
   ...
   * (requires Claude account to be connected with AIPRM account & max. private prompts quota not exceeded)
   *
  ...
  canUseLiveCrawling() {
    ...
    // Show modal to upgrade account to use "Live Crawling" (or Connect Claude account to AIPRM account and then upgrade, if not connected)
    this.showModal(
      !this.#user.IsLinked
  ...
  canUseHideWatermark(showModal = true) {
    ...
    if (showModal) {
      // Show modal to upgrade account to use "Hide Watermark" (or Connect Claude account to AIPRM account and then upgrade, if not connected)
      this.showModal(
        !this.#user.IsLinked
  ...
  canUseCustomIndexes() {
    ...
    // Show modal to upgrade account to use "Custom Indexes" (or Connect Claude account to AIPRM account and then upgrade, if not connected)
    this.showModal(
      !this.#user.IsLinked
        ? QuotaMessages.CONNECT_ACCOUNT_DOCUMENT_INDEX_INCORRECT_PLAN
        : QuotaMessages.UPGRADE_ACCOUNT_DOCUMENT_INDEX_INCORRECT_PLAN,
  ...
  /**
   * Show modal with announcement to Connect Claude account to AIPRM account
   *
   * @returns {boolean}
   */
  ...
  hasFeatureEnabled(feature) {
    // Claude account must be connected to AIPRM account before checking for features
    if (!this.#user.IsLinked) {
      return false;
    }
